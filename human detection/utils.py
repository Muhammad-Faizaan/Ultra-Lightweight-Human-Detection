...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.ec608a6bd4a868556b2c.module.css" />
  ...
  <title>UHD/uhd/utils.py at main · PINTO0309/UHD</title>
  ...
  <meta name="fetch-nonce" content="v2:066f4dc5-20be-c234-a304-49ef0b990893">

    
  <meta name="current-catalog-service-hash" content="f3abb0cc802f3d7b95fc8762b94bdcb13bf39634c40c357301c4aa1d67a256fb">


  <meta name="request-id" content="8AFE:2EF127:D2FA8:10124A:697F9DF0" data-turbo-transient="true" /><meta name="html-safe-nonce" content="84409d774c6f9f1e6c726a73f1a0f26dd441bd8bc24e683655e5cb3253b46b92" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="b5e71efdc43df4775f327a214e9e62544577e1b3c131a00beaf1486161b9ebd8" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="219181390" /><meta name="octolytics-actor-login" content="Muhammad-Faizaan" /><meta name="octolytics-actor-hash" content="e4e1c6ca10bb7a2e38f04dfb8958242782e529ff9ef6abf9f120d1755d1781ae" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="viewport" content="width=device-width">
      ...
      <meta name="description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detection architectures such as YOLO are overkill. - UHD/uhd/utils.py at main · PINTO0309/UHD">

      <link rel="search" type="application/opensearchdescription+xml" href="/opensearch.xml" title="GitHub">

    <link rel="fluid-icon" href="https://github.com/fluidicon.png" title="GitHub">
    <meta property="fb:app_id" content="1401488693436528">
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/PINTO0309/UHD/blob/main/uhd/utils.py" />

      <meta name="twitter:image" content="https://repository-images.githubusercontent.com/1104203107/343274bb-e70b-47e5-b1bf-378e4524cdf7" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="UHD/uhd/utils.py at main · PINTO0309/UHD" /><meta name="twitter:description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." />
  <meta property="og:image" content="https://repository-images.githubusercontent.com/1104203107/343274bb-e70b-47e5-b1bf-378e4524cdf7" /><meta property="og:image:alt" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="UHD/uhd/utils.py at main · PINTO0309/UHD" /><meta property="og:url" content="https://github.com/PINTO0309/UHD/blob/main/uhd/utils.py" /><meta property="og:description" content="Ultra-lightweight human detection. The number of parameters does not correlate to inference speed. For limited use cases, an input image resolution of 64x64 is sufficient. High-level object detecti..." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/219181390/ws?session=eyJ2IjoiVjMiLCJ1IjoyMTkxODEzOTAsInMiOjE5NDk3NTg2MTcsImMiOjI5NDQxNzQxODAsInQiOjE3Njk5NzExODV9--af3829c293a1862d3abcd4b99ae3b48ee1eff3cb17cea32590e7c3a3e5e285fd" data-refresh-url="/_alive" data-session-id="8e478665edf3f192f7b62ad2e45e5990f713551b60600e7c00903f8d113aeb1e">
...
<qbsearch-input class="search-input" data-scope="repo:PINTO0309/UHD" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="yISV-XRQ-MVPsaBS4Sby5jqaBVsnI_QMyiA4SWcPkEZd5V2MUNsWDkyl1EjQ2VzFL2BEIOOPIiZYU69KpDanmg" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="PINTO0309/UHD" data-current-org="" data-current-owner="PINTO0309" data-logged-in="true" data-copilot-chat-enabled="true" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-b5fe9447-8bdd-42fc-b2e3-4838ea8bdfbe" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-b5fe9447-8bdd-42fc-b2e3-4838ea8bdfbe" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="BltCPiInCdhRfOBM13Ha8cvArPrt6sT0zR72B9JSmDS-EVf5hmn6tt0k_yQuGjAGAtOGJm6Pdk_1xDtsxO45YA" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="wYmSTzb-OUsBzyGuMgDQTuR8suW7UKJhADXg_XUedD0-nCtQuScrdEt0vY7z3lVSBD5CXA3f3lne8p3Jc8n3tw" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="XQk1Xho0PHe3edoju7egZ-9aZ-LqhuExDFfuhmUxGaE7SWJZhDBOKtTJZN3sN_nmxDKo1JL37XtrFcRUNibY4A" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="xzCJu_GUFAP3KLoPFQZZuVY9nP6hORJzy6g674keVh96x2c7AQShgOldStvW8Po4QnT_0LfIFa5KIElaTnaRjQ" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <button id="icon-button-d33b9d79-4f3c-437c-8743-e563eacc7331" aria-labelledby="tooltip-56f4ced7-54f2-404e-998c-622addb423f9" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-56f4ced7-54f2-404e-998c-622addb423f9" for="icon-button-d33b9d79-4f3c-437c-8743-e563eacc7331" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MjE5MTgxMzkwIiwidCI6MTc2OTk3MTE4NX0=--edc194644d2a6729ef82e73f94bd62046ac578f6b8999c2feced94a57ce08029" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/PINTO0309/UHD/blob/main/uhd/utils.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"codeLineWrapEnabled":false,"refInfo":{"name":"main","listCacheKey":"v0:1767509170.0","canEdit":true,"refType":"branch","currentOid":"f4dd3bf4a9b4c4928d6f05f593fde7189c9eb30b","canEditOnDefaultBranch":true,"fileExistsOnDefault":true},"path":"uhd/utils.py","blob":{"rawLines":["import os","import random","from typing import Any, Dict","","import numpy as np","import torch","","","def set_seed(seed: int) -\u003e None:","    random.seed(seed)","    np.random.seed(seed)","    torch.manual_seed(seed)","    torch.cuda.manual_seed_all(seed)","","","def default_device(device_arg: str) -\u003e torch.device:","    if device_arg:","        return torch.device(device_arg)","    return torch.device(\"cuda\" if torch.cuda.is_available() else \"cpu\")","","","def ensure_dir(path: str) -\u003e None:","    if path and not os.path.exists(path):","        os.makedirs(path, exist_ok=True)","","","def move_targets(targets, device):","    moved = []","    for t in targets:","        moved.append(","            {","                \"boxes\": t[\"boxes\"].to(device),","                \"labels\": t.get(\"labels\", torch.zeros(len(t[\"boxes\"]), dtype=torch.long)).to(device),","                \"image_id\": t[\"image_id\"],","                \"orig_size\": t.get(\"orig_size\"),","            }","        )","    return moved"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eos\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003erandom\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003etyping\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eAny\u003c/span\u003e, \u003cspan class=pl-v\u003eDict\u003c/span\u003e","","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003enumpy\u003c/span\u003e \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003enp\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003etorch\u003c/span\u003e","","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eset_seed\u003c/span\u003e(\u003cspan class=pl-s1\u003eseed\u003c/span\u003e: \u003cspan class=pl-smi\u003eint\u003c/span\u003e) \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-c1\u003eNone\u003c/span\u003e:","    \u003cspan class=pl-s1\u003erandom\u003c/span\u003e.\u003cspan class=pl-c1\u003eseed\u003c/span\u003e(\u003cspan class=pl-s1\u003eseed\u003c/span\u003e)","    \u003cspan class=pl-s1\u003enp\u003c/span\u003e.\u003cspan class=pl-c1\u003erandom\u003c/span\u003e.\u003cspan class=pl-c1\u003eseed\u003c/span\u003e(\u003cspan class=pl-s1\u003eseed\u003c/span\u003e)","    \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003emanual_seed\u003c/span\u003e(\u003cspan class=pl-s1\u003eseed\u003c/span\u003e)","    \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003ecuda\u003c/span\u003e.\u003cspan class=pl-c1\u003emanual_seed_all\u003c/span\u003e(\u003cspan class=pl-s1\u003eseed\u003c/span\u003e)","","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003edefault_device\u003c/span\u003e(\u003cspan class=pl-s1\u003edevice_arg\u003c/span\u003e: \u003cspan class=pl-smi\u003estr\u003c/span\u003e) \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003edevice\u003c/span\u003e:","    \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003edevice_arg\u003c/span\u003e:","        \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003edevice\u003c/span\u003e(\u003cspan class=pl-s1\u003edevice_arg\u003c/span\u003e)","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003edevice\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;cuda\u0026quot;\u003c/span\u003e \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003ecuda\u003c/span\u003e.\u003cspan class=pl-c1\u003eis_available\u003c/span\u003e() \u003cspan class=pl-k\u003eelse\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026quot;cpu\u0026quot;\u003c/span\u003e)","","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eensure_dir\u003c/span\u003e(\u003cspan class=pl-s1\u003epath\u003c/span\u003e: \u003cspan class=pl-smi\u003estr\u003c/span\u003e) \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-c1\u003eNone\u003c/span\u003e:","    \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003epath\u003c/span\u003e \u003cspan class=pl-c1\u003eand\u003c/span\u003e \u003cspan class=pl-c1\u003enot\u003c/span\u003e \u003cspan class=pl-s1\u003eos\u003c/span\u003e.\u003cspan class=pl-c1\u003epath\u003c/span\u003e.\u003cspan class=pl-c1\u003eexists\u003c/span\u003e(\u003cspan class=pl-s1\u003epath\u003c/span\u003e):","        \u003cspan class=pl-s1\u003eos\u003c/span\u003e.\u003cspan class=pl-c1\u003emakedirs\u003c/span\u003e(\u003cspan class=pl-s1\u003epath\u003c/span\u003e, \u003cspan class=pl-s1\u003eexist_ok\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003eTrue\u003c/span\u003e)","","","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003emove_targets\u003c/span\u003e(\u003cspan class=pl-s1\u003etargets\u003c/span\u003e, \u003cspan class=pl-s1\u003edevice\u003c/span\u003e):","    \u003cspan class=pl-s1\u003emoved\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e []","    \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003et\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003etargets\u003c/span\u003e:","        \u003cspan class=pl-s1\u003emoved\u003c/span\u003e.\u003cspan class=pl-c1\u003eappend\u003c/span\u003e(","            {","                \u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s1\u003et\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e].\u003cspan class=pl-c1\u003eto\u003c/span\u003e(\u003cspan class=pl-s1\u003edevice\u003c/span\u003e),","                \u003cspan class=pl-s\u003e\u0026quot;labels\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s1\u003et\u003c/span\u003e.\u003cspan class=pl-c1\u003eget\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;labels\u0026quot;\u003c/span\u003e, \u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003ezeros\u003c/span\u003e(\u003cspan class=pl-en\u003elen\u003c/span\u003e(\u003cspan class=pl-s1\u003et\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;boxes\u0026quot;\u003c/span\u003e]), \u003cspan class=pl-s1\u003edtype\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003etorch\u003c/span\u003e.\u003cspan class=pl-c1\u003elong\u003c/span\u003e)).\u003cspan class=pl-c1\u003eto\u003c/span\u003e(\u003cspan class=pl-s1\u003edevice\u003c/span\u003e),","                \u003cspan class=pl-s\u003e\u0026quot;image_id\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s1\u003et\u003c/span\u003e[\u003cspan class=pl-s\u003e\u0026quot;image_id\u0026quot;\u003c/span\u003e],","                \u003cspan class=pl-s\u003e\u0026quot;orig_size\u0026quot;\u003c/span\u003e: \u003cspan class=pl-s1\u003et\u003c/span\u003e.\u003cspan class=pl-c1\u003eget\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;orig_size\u0026quot;\u003c/span\u003e),","            }","        )","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003emoved\u003c/span\u003e"],"csv":null,"csvError":null,"copilotSWEAgentEnabled":false,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/PINTO0309/UHD/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"utils.py","displayUrl":"https://github.com/PINTO0309/UHD/blob/main/uhd/utils.py?raw=true","headerInfo":{"blobSize":"932 Bytes","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"x-github-client://openRepo/https://github.com/PINTO0309/UHD?branch=main\u0026filepath=uhd%2Futils.py","isGitLfs":false,"onBranch":true,"shortPath":"4ce424a","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2FPINTO0309%2FUHD%2Fblob%2Fmain%2Fuhd%2Futils.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"38","truncatedSloc":"29"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/PINTO0309/UHD/blob/main/uhd/utils.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/PINTO0309/UHD/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/PINTO0309/UHD/raw/refs/heads/main/uhd/utils.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":4,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"set_seed","kind":"function","ident_start":92,"ident_end":100,"extent_start":88,"extent_end":232,"fully_qualified_name":"set_seed","ident_utf16":{"start":{"line_number":8,"utf16_col":4},"end":{"line_number":8,"utf16_col":12}},"extent_utf16":{"start":{"line_number":8,"utf16_col":0},"end":{"line_number":12,"utf16_col":36}}},{"name":"default_device","kind":"function","ident_start":239,"ident_end":253,"extent_start":235,"extent_end":418,"fully_qualified_name":"default_device","ident_utf16":{"start":{"line_number":15,"utf16_col":4},"end":{"line_number":15,"utf16_col":18}},"extent_utf16":{"start":{"line_number":15,"utf16_col":0},"end":{"line_number":18,"utf16_col":71}}},{"name":"ensure_dir","kind":"function","ident_start":425,"ident_end":435,"extent_start":421,"extent_end":538,"fully_qualified_name":"ensure_dir","ident_utf16":{"start":{"line_number":21,"utf16_col":4},"end":{"line_number":21,"utf16_col":14}},"extent_utf16":{"start":{"line_number":21,"utf16_col":0},"end":{"line_number":23,"utf16_col":40}}},{"name":"move_targets","kind":"function","ident_start":545,"ident_end":557,"extent_start":541,"extent_end":931,"fully_qualified_name":"move_targets","ident_utf16":{"start":{"line_number":26,"utf16_col":4},"end":{"line_number":26,"utf16_col":16}},"extent_utf16":{"start":{"line_number":26,"utf16_col":0},"end":{"line_number":37,"utf16_col":16}}}]}},"copilotInfo":null,"copilotAccessAllowed":true,"copilotSpacesEnabled":true,"modelsAccessAllowed":false,"modelsRepoIntegrationEnabled":false,"isMarketplaceEnabled":true,"allShortcutsEnabled":true,"fileTree":{"uhd":{"items":[{"name":"__init__.py","path":"uhd/__init__.py","contentType":"file"},{"name":"aug.yaml","path":"uhd/aug.yaml","contentType":"file"},{"name":"aug_headpose.yaml","path":"uhd/aug_headpose.yaml","contentType":"file"},{"name":"augment.py","path":"uhd/augment.py","contentType":"file"},{"name":"backbones.py","path":"uhd/backbones.py","contentType":"file"},{"name":"data.py","path":"uhd/data.py","contentType":"file"},{"name":"losses.py","path":"uhd/losses.py","contentType":"file"},{"name":"metrics.py","path":"uhd/metrics.py","contentType":"file"},{"name":"models.py","path":"uhd/models.py","contentType":"file"},{"name":"quantize_onnx_model_for_esp32.py","path":"uhd/quantize_onnx_model_for_esp32.py","contentType":"file"},{"name":"resize.py","path":"uhd/resize.py","contentType":"file"},{"name":"uhd_qat.py","path":"uhd/uhd_qat.py","contentType":"file"},{"name":"ultratinyod.py","path":"uhd/ultratinyod.py","contentType":"file"},{"name":"utils.py","path":"uhd/utils.py","contentType":"file"}],"totalCount":14},"":{"items":[{"name":"ckpts","path":"ckpts","contentType":"directory"},{"name":"uhd","path":"uhd","contentType":"directory"},{"name":".gitignore","path":".gitignore","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"compare_torchvision_cv2_resize.py","path":"compare_torchvision_cv2_resize.py","contentType":"file"},{"name":"compare_wpost_wopost.py","path":"compare_wpost_wopost.py","contentType":"file"},{"name":"demo_uhd.py","path":"demo_uhd.py","contentType":"file"},{"name":"demo_uhd_lite.py","path":"demo_uhd_lite.py","contentType":"file"},{"name":"export_cpp.py","path":"export_cpp.py","contentType":"file"},{"name":"export_onnx.py","path":"export_onnx.py","contentType":"file"},{"name":"profile_onnx.py","path":"profile_onnx.py","contentType":"file"},{"name":"pyproject.toml","path":"pyproject.toml","contentType":"file"},{"name":"train.py","path":"train.py","contentType":"file"},{"name":"uhd_export_bin.h","path":"uhd_export_bin.h","contentType":"file"},{"name":"uv.lock","path":"uv.lock","contentType":"file"}],"totalCount":16}},"fileTreeProcessingTime":11.572118,"incompleteFileTree":false,"foldersToFetch":[],"repo":{"id":1104203107,"defaultBranch":"main","name":"UHD","ownerLogin":"PINTO0309","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2025-11-26T03:34:25.000+05:00","ownerAvatar":"https://avatars.githubusercontent.com/u/33194443?v=4","public":true,"private":false,"isOrgOwned":false},"currentUser":{"id":219181390,"login":"Muhammad-Faizaan","userEmail":"mohammadfaizan0997@gmail.com"},"csrf_tokens":{"/PINTO0309/UHD/branches":{"post":"n5Ec2HMOIrZVqFJWakb4Dg9IO0b910JZpMBFoia__ATNEFVTwOnrlwazhTiCSgx4SRS0h9aS0RfFa3PaCaHxXg"}}},"title":"UHD/uhd/utils.py at main · PINTO0309/UHD","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-5acd58e615f7.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-c073d0e0b342.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"accessible_code_button":true}}}</script>
...
<div id="LC3" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>from</span> <span class=pl-s1>typing</span> <span class=pl-k>import</span> <span class=pl-v>Any</span>, <span class=pl-v>Dict</span></div>
...
<div id="LC6" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>import</span> <span class=pl-s1>torch</span></div>
...
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>set_seed</span>(<span class=pl-s1>seed</span>: <span class=pl-smi>int</span>) <span class=pl-c1>-&gt;</span> <span class=pl-c1>None</span>:</div>
<div id="LC10" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-8 ">    <span class=pl-s1>random</span>.<span class=pl-c1>seed</span>(<span class=pl-s1>seed</span>)</div>
<div id="LC11" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-8 ">    <span class=pl-s1>np</span>.<span class=pl-c1>random</span>.<span class=pl-c1>seed</span>(<span class=pl-s1>seed</span>)</div>
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-8 ">    <span class=pl-s1>torch</span>.<span class=pl-c1>manual_seed</span>(<span class=pl-s1>seed</span>)</div>
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>torch</span>.<span class=pl-c1>cuda</span>.<span class=pl-c1>manual_seed_all</span>(<span class=pl-s1>seed</span>)</div>
...
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>default_device</span>(<span class=pl-s1>device_arg</span>: <span class=pl-smi>str</span>) <span class=pl-c1>-&gt;</span> <span class=pl-s1>torch</span>.<span class=pl-c1>device</span>:</div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>if</span> <span class=pl-s1>device_arg</span>:</div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>return</span> <span class=pl-s1>torch</span>.<span class=pl-c1>device</span>(<span class=pl-s1>device_arg</span>)</div>
<div id="LC19" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-s1>torch</span>.<span class=pl-c1>device</span>(<span class=pl-s>&quot;cuda&quot;</span> <span class=pl-k>if</span> <span class=pl-s1>torch</span>.<span class=pl-c1>cuda</span>.<span class=pl-c1>is_available</span>() <span class=pl-k>else</span> <span class=pl-s>&quot;cpu&quot;</span>)</div>
...
<div id="LC22" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>ensure_dir</span>(<span class=pl-s1>path</span>: <span class=pl-smi>str</span>) <span class=pl-c1>-&gt;</span> <span class=pl-c1>None</span>:</div>
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>if</span> <span class=pl-s1>path</span> <span class=pl-c1>and</span> <span class=pl-c1>not</span> <span class=pl-s1>os</span>.<span class=pl-c1>path</span>.<span class=pl-c1>exists</span>(<span class=pl-s1>path</span>):</div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-s1>os</span>.<span class=pl-c1>makedirs</span>(<span class=pl-s1>path</span>, <span class=pl-s1>exist_ok</span><span class=pl-c1>=</span><span class=pl-c1>True</span>)</div>
...
<div id="LC27" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>move_targets</span>(<span class=pl-s1>targets</span>, <span class=pl-s1>device</span>):</div>
<div id="LC28" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">    <span class=pl-s1>moved</span> <span class=pl-c1>=</span> []</div>
<div id="LC29" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">    <span class=pl-k>for</span> <span class=pl-s1>t</span> <span class=pl-c1>in</span> <span class=pl-s1>targets</span>:</div>
<div id="LC30" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">        <span class=pl-s1>moved</span>.<span class=pl-c1>append</span>(</div>
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">            {</div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">                <span class=pl-s>&quot;boxes&quot;</span>: <span class=pl-s1>t</span>[<span class=pl-s>&quot;boxes&quot;</span>].<span class=pl-c1>to</span>(<span class=pl-s1>device</span>),</div>
<div id="LC33" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">                <span class=pl-s>&quot;labels&quot;</span>: <span class=pl-s1>t</span>.<span class=pl-c1>get</span>(<span class=pl-s>&quot;labels&quot;</span>, <span class=pl-s1>torch</span>.<span class=pl-c1>zeros</span>(<span class=pl-en>len</span>(<span class=pl-s1>t</span>[<span class=pl-s>&quot;boxes&quot;</span>]), <span class=pl-s1>dtype</span><span class=pl-c1>=</span><span class=pl-s1>torch</span>.<span class=pl-c1>long</span>)).<span class=pl-c1>to</span>(<span class=pl-s1>device</span>),</div>
<div id="LC34" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">                <span class=pl-s>&quot;image_id&quot;</span>: <span class=pl-s1>t</span>[<span class=pl-s>&quot;image_id&quot;</span>],</div>
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-26 ">                <span class=pl-s>&quot;orig_size&quot;</span>: <span class=pl-s1>t</span>.<span class=pl-c1>get</span>(<span class=pl-s>&quot;orig_size&quot;</span>),</div>
